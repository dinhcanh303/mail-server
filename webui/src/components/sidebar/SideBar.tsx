...
import Logo from '../../assets/tlc.png'
import { MdHistory, MdOutlineSettings } from 'react-icons/md'
import { FaMailBulk, FaServer } from 'react-icons/fa'
  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5'>
        <NavLink to='/'>
          <img src={Logo} alt='Logo' className='w-30 h-14 object-cover' />
        </NavLink>
        ...
        <button
          ...
          aria-expanded={sidebarOpen as any}
      ...
      <div className='no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear'>
        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          ...
          <div>
            <h3 className='mb-4 ml-4 text-sm font-semibold text-bodydark2'>HISTORIES</h3>
